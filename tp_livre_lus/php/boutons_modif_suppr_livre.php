...
<form method='get' action='/private/git/tp_livre_lus/php/form_modif.php' name='modification'>
                              <input type='hidden' name='id' id='id' value="<?php echo $donnees['id'];?>"/>
                              <input type='submit' value='modifier' class='bouton_supprimer'/></form> <!-- class donnée pour mettre dans la grille css!-->
                            <form method='post' action='/private/git/tp_livre_lus/php/delete_one.php' name='delete'>

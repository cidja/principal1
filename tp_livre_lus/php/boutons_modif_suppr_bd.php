<form method='get' action='/private/git/tp_livre_lus/php/form_modif_bd.php' name='modification'>
                              <input type='hidden' name='id' id='id' value="<?php echo $donnees['id'];?>"/>
                              <input type='submit' value='modifier' class='bouton_modif'/></form> <!-- class donnée pour mettre dans la grille css!-->
                            <form method='post' action='/private/git/tp_livre_lus/php/delete_one_bd.php' name='delete'>

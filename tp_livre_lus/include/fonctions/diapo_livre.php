<?php
include_once('/var/www/public/private/git/tp_livre_lus/include/config.inc.php'); //inclusion du fichier connexion pour la base de données
include_once('/var/www/public/private/git/tp_livre_lus/include/debug.php'); //inclusion du fichier debug avec les fonctions utiles pour debuger
echo 'test';
function ficheLivre(){ 
  global $bdd;
